...
function ShopContent() {
  ...
  const getFilteredByCategoryProducts = (): PostType[] => {
    ...
    return uniqueSelectedIndices
      .map((i) => Product[i])
      .filter((product): product is PostType => product !== undefined);
  };
  ...
  let combinedFilteredProducts: PostType[] = [];
          ...
          <div className="row g-0">
            ...
            <div className="col-xl-3 col-lg-12 pr--70 pr_lg--10 pr_sm--10 pr_md--5 rts-sticky-column-item">
              <div className="sidebar-filter-main theiaStickySidebar">
                ...
                {/* Categories */}
                <div className="single-filter-box">
                  <h5 className="title">Catégories de produits</h5>
                  <div className="filterbox-body">
                ...
                {/* Brands */}
                <div className="single-filter-box">
                  <h5 className="title">Sélectionnez les plats</h5>
                  <div className="filterbox-body">
                    <div className="category-wrapper">
            ...
            <div className="col-xl-9 col-lg-12">
              <div className="filter-select-area">
                <div className="top-filter">
                  <span>Affichage de {filteredProducts.length} résultats</span>
                  <div className="right-end">
                    <span>Trier : Trier par les plus récents</span>
